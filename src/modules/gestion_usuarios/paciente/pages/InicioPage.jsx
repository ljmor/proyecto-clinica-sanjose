...
import { appLogout, setActiveRegister } from '../../store/paciente/pacienteSlice';
...
export const InicioPage = () => {
    ...
    const toHistories = () => {
        dispatch(setActiveRegister(resp.user));
        navigate('historias');
    }
                ...
                >
                    ...
                    >
                        <Typography variant="h6" sx={{ mb: 6, color: '#00695c' }}>
                            Este es su panel hospitalario para la visualización de sus historias clínicas
                        </Typography>
                    </motion.div>
